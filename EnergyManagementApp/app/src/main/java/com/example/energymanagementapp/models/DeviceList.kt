    ...
    companion object {
        fun getDevices(): ArrayList<Device> {
            return arrayListOf(
                ...
                Device("Watering system", "But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings ", "Garden", "admin",false),
